...
class PrimeCoachWorkoutSeeder extends Seeder
{
    public function run(): void
    {
        $owner = User::role('owner')->first();
        $path = database_path('data/primecoach_vimeo_exercises.json');
        ...
        $workoutTemplates = [
            [
                ...
                'description' => 'Baseado nos vídeos Prime Coaching (Vimeo)',
                'exercise_indexes' => [0, 1, 2, 8, 9],
            ],
            [
                'member_index' => 1,
                'name' => 'Treino B — Superior + Core',
                'description' => 'Prescrição inicial com material local Prime Coaching',
