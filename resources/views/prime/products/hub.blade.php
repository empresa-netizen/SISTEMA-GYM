...
<div class="prime-clients-page">
    <div class="prime-clients-toolbar">
        ...
        <div class="prime-clients-toolbar__right">
            <a href="{{ route('membership-plans.index') }}" class="prime-btn-ghost"><i class="ri-price-tag-3-line"></i> Planos</a>
            <a href="{{ route('products.coupons') }}" class="prime-btn-ghost"><i class="ri-coupon-3-line"></i> Cupons</a>
            <button type="button" class="prime-btn-primary" data-bs-toggle="modal" data-bs-target="#productModal">
    ...
    <div class="prime-hub-split mb-3">
        @foreach([
            ...
            <a href="{{ route($card['route']) }}" class="prime-client-card text-decoration-none">
    ...
    <div class="prime-panel-label mb-2">VITRINE LOCAL</div>
    <div class="prime-client-list">
        @forelse($products ?? [] as $product)
            <div class="prime-client-card">
                <div class="prime-client-card__main">
                    ...
                    <div class="prime-client-card__identity">
                        <div class="prime-client-card__name">{{ $product->name }}</div>
        ...
        @empty
            <div class="prime-empty-state">
                ...
                <button type="button" class="prime-btn-primary" data-bs-toggle="modal" data-bs-target="#productModal">Criar produto</button>
            </div>
        @endforelse
    </div>
</div>
