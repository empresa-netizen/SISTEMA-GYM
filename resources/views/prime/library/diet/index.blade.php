...
<div class="prime-clients-page">
    <div class="prime-clients-toolbar">
        <div class="prime-clients-toolbar__left">
            <h1 class="prime-page-title mb-0">Dieta e protocolo</h1>
    ...
    <p class="prime-page-sub mb-0">Acesse alimentos, fórmulas, cardápios e modelos de refeições no padrão Prime.</p>
