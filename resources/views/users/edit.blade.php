...
@section('content')
<div class="mb-4">
    <h1 class="mg-page-title">Editar colaborador</h1>
    <p class="mg-section-label mb-1">Atualize dados, perfil e senha de {{ $user->name }}.</p>
</div>
            ...
            <div class="mg-panel-body">
                ...
                <form action="{{ route('users.update', $user->id) }}" method="POST">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('account.collaborators') }}" class="mg-btn mg-btn-outline">
