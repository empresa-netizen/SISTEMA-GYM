...
<div class="mg-clients-page">
    <div class="mg-clients-toolbar">
        <div class="mg-clients-toolbar__left">
            <h1 class="mg-page-title mb-0">Novo plano</h1>
    ...
    <form action="{{ route('membership-plans.store') }}" method="POST" class="mg-form-stack">
        @csrf
        ...
        <div class="mg-panel mg-panel--compact">
            ...
            <div class="mg-form-grid">
                <div>
                    ...
                    <input type="text" class="mg-field @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required>
                    @error('name')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror
                </div>
                <div>
                    <label for="price" class="mg-field-label">Preço (R$)</label>
                    <input type="number" step="0.01" class="mg-field @error('price') is-invalid @enderror" id="price" name="price" value="{{ old('price') }}" required>
                ...
                <div>
                    ...
                    <input type="number" class="mg-field @error('duration_value') is-invalid @enderror" id="duration_value" name="duration_value" value="{{ old('duration_value', 1) }}" required>
                ...
                <div class="mg-form-grid__full">
                    ...
                    <textarea class="mg-field @error('description') is-invalid @enderror" id="description" name="description" rows="3">{{ old('description') }}</textarea>
        ...
        <div class="mg-form-actions">
            ...
            <button type="submit" class="mg-btn-primary"><i class="ri-save-line"></i> Criar plano</button>
        </div>
    </form>
</div>
@endsection
