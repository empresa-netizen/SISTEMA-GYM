...
@section('content')
<div class="mb-4">
    <h1 class="mg-page-title">Buscar</h1>
    <p class="mg-page-sub">Clientes, treinos e faturas.</p>
</div>
    ...
    <div class="row g-4">
        <div class="col-lg-4">
            ...
            @forelse($members as $member)
                <a href="{{ route('members.show', $member) }}" class="mg-search-item">
        ...
        <div class="col-lg-4">
            ...
            @forelse($workouts as $workout)
                <a href="{{ route('workouts.show', $workout) }}" class="mg-search-item">
        ...
        <div class="col-lg-4">
            ...
            @forelse($invoices as $invoice)
                <a href="{{ route('invoices.show', $invoice) }}" class="mg-search-item">
