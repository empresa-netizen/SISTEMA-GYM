...
<div class="mg-clients-page">
    <div class="mg-clients-toolbar">
        <div class="mg-clients-toolbar__left">
            <h1 class="mg-page-title mb-0">Bibliotecas</h1>
            <p class="mg-page-sub mb-0">Templates de treino, dieta e cursos para acelerar a prescrição.</p>
        </div>
    </div>
    ...
    <div class="row g-3">
        @foreach([
            ...
            <div class="col-xl-4 col-md-6">
                <a href="{{ route($card['route']) }}" class="mg-client-card text-decoration-none h-100">
