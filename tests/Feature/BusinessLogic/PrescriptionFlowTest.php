...
describe('Prescription flow business logic', function () {
    ...
    it('imports a library workout from the member profile and shows saved exercises', function () {
        ...
        $this->actingAs($owner)
            ...
            ->assertOk()
            ->assertSee('mg-rx--workout', false)
            ->assertSee('mg-rx-empty', false)
        ...
        $this->actingAs($owner)
            ...
            ->assertOk()
            ->assertSee('mg-rx--workout', false)
            ->assertSee('mg-rx-card__icon', false)
            ->assertSee('mg-rx-workout-grid', false)
            ->assertSee('Template Web Pernas')
            ->assertSee('Leg press')
            ->assertSee('Séries')
            ->assertSee('Reps')
