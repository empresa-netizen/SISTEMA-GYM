# Mapa de telas — Referencia Visual → MGTEAM

Fonte: `referencia-visual-local` (conta real) · Clone: `http://localhost:8000`

## Clientes (submenu expandido)

| MGTEAM URL | Label | Local |
|-----------|-------|-------|
